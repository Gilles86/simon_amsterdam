...
modelfit_workflow = create_modelfit_workflow(name='modelfit_puck_tactile')
...
ds.inputs.base_directory = '/home/gdholla1/data/simon_amsterdam/modelfit_tactile'
